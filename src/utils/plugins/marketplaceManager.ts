 ...
 *
 * Reads the configuration file at ~/.freecc/plugins/known_marketplaces.json
 ...
 *
 * Writes the configuration to ~/.freecc/plugins/known_marketplaces.json,
 ...
 * The configuration is saved to ~/.freecc/plugins/known_marketplaces.json.
 *
